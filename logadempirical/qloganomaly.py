import os
from logadempirical.logdeep.models.lstm import qloganomaly
...
def run_qloganomaly(options):
    if not os.path.exists(options["vocab_path"]):
        ...
        vocab = Vocab(logs, os.path.join(options['data_dir'], "new_embeddings.json"), "qloganomaly")
