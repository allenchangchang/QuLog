...
from logadempirical.quantumlstm import run_qlstm
from logadempirical.loganomaly import run_loganomaly
from logadempirical.qloganomaly import run_qloganomaly
from logadempirical.logrobust import run_logrobust
from logadempirical.qlogrobust import run_qlogrobust
...
def arg_parser():
    ...
    parser.add_argument("--embeddings", default="new_embeddings.json", help="template embedding json file")
    ...
    parser.add_argument("--n_qlayers", default=1, type=int)
    parser.add_argument("--n_vrotations", default=3, type=int)
    parser.add_argument("--batch_first", default=True)
    parser.add_argument("--return_sequences", default=False)
    parser.add_argument("--return_state", default=False)
...
def main():
    ...
    if args.model_name == "logbert":
        ...
        run_deeplog(options)
    elif args.model_name == "qlstm":
        run_qlstm(options)
    elif args.model_name == "loganomaly":
        run_loganomaly(options)
    elif args.model_name == "qloganomaly":
        run_qloganomaly(options)
    elif args.model_name == "logrobust":
        run_logrobust(options)
    elif args.model_name == "qlogrobust":
        run_logrobust(options)
